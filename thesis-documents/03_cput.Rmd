...
#| fig.scap = "A general prospect diagram, an explicit representation of a prospect with two options.",
...
#| echo = FALSE, warning = FALSE, fig.align = "center",
#| fig.scap = "Prospect diagram representing an example problem from Kahneman and Tversky (1979).",
