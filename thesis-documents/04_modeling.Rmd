...
#| echo = FALSE, warning = FALSE, fig.align = "center", fig.width = 1.619 * 5, fig.height = 5, dpi = 300, out.width = "95%",
#| fig.scap = "Illustration of logistic transformation (softmax) function for converting the difference in utilities to a choice probability.",
